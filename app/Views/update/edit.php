...
<li>
  ...
  <div class="create">
          <form action="/page/update/<?= $mcd['id']?>" method="post" class="footer-form">
            <?= csrf_field(); ?>
